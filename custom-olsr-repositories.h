...
#ifndef CUSTOM_OLSR_REPOSITORIES_H
#define CUSTOM_OLSR_REPOSITORIES_H
...
struct LinkTuple
{
  ...
  /// Time at which this tuple expires and must be removed.
  Time time;
  /// The routing metric of the neighbor node.
  double neighborRoutingMetric;
};
...
struct TwoHopNeighborTuple
{
  ...
  /// Routing metric of 2 hop neighbor
  double routingMetric;
};
...
struct MprSelectorTuple
{
  ...
  /// Time at which this tuple expires and must be removed.
  Time expirationTime; // previously called 'time_'
  ///Routing metric of a node which have selected this node as a MPR.
  double routingMetric;
};
...
struct TopologyTuple
{
  ...
  /// Time at which this tuple expires and must be removed.
  Time expirationTime;
  /// Routing metric of the node which is a neighbor of the destination.
  double lastAddrRoutingMetric;
};
