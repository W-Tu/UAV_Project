...
#ifndef CUSTOM_AODV_ROUTING_PROTOCOL_HELPER_H
#define CUSTOM_AODV_ROUTING_PROTOCOL_HELPER_H
 ...
 */
class customAodvHelper : public Ipv4RoutingHelper
{
public:
  customAodvHelper ();
   ...
   */
  customAodvHelper* Copy (void) const;
...
#endif /* CUSTOM_AODV_ROUTING_PROTOCOL_HELPER_H */
