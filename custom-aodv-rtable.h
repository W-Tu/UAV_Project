 ...
 */
#ifndef CUSTOM_AODV_RTABLE_H
#define CUSTOM_AODV_RTABLE_H
...
public:
  ...
  RoutingTableEntry (Ptr<NetDevice> dev = 0,Ipv4Address dst = Ipv4Address (), bool vSeqNo = false, uint32_t seqNo = 0,
                     ...
                     Ipv4Address nextHop = Ipv4Address (), Time lifetime = Simulator::Now (), double routingMetric = 1.0f);
   ...
   * \param routingMetric the routing metric value
   */
  void SetRoutingMetric(double routingMetric);
  /**
   * Gets the routing metric
   * \returns the routing metric
   */
