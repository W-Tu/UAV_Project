...
#ifndef CUSTOM_OLSR_HEADER_H
#define CUSTOM_OLSR_HEADER_H
...
public:
  ...
  /**
   * Set the routing metric value.
   * \param double the new routing metric.
   */
  void SetRoutingMetric(double routingMetric)
  {
    m_routingMetric = routingMetric;
  }
  /**
...
private:
  ...
  double m_routingMetric; //!< The message size.
